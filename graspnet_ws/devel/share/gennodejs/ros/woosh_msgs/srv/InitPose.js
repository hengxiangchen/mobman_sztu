...
class InitPoseRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitPoseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitPoseRequest
    let len;
    let data = new InitPoseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitPoseRequest(null);
...
class InitPoseResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitPoseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitPoseResponse
    let len;
    let data = new InitPoseResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitPoseResponse(null);
...
module.exports = {
  ...
  Response: InitPoseResponse,
  md5sum() { return 'd85ac5803be8daa00e52d453ae42eb7d'; },
  datatype() { return 'woosh_msgs/InitPose'; }
};
