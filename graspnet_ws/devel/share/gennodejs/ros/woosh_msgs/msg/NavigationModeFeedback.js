...
class NavigationModeFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NavigationModeFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigationModeFeedback(null);
...
module.exports = NavigationModeFeedback;
