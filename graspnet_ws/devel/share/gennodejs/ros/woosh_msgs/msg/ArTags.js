...
class ArTags {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.ArTags[i] = ArTagPose.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 84 * object.ArTags.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArTags(null);
    ...
    if (msg.ArTags !== undefined) {
      ...
      for (let i = 0; i < resolved.ArTags.length; ++i) {
        resolved.ArTags[i] = ArTagPose.Resolve(msg.ArTags[i]);
      }
    }
    else {
      resolved.ArTags = []
