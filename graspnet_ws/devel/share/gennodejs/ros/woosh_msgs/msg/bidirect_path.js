...
class bidirect_path {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new bidirect_path(null);
  ...
  static datatype() {
    ...
    return 'woosh_msgs/bidirect_path';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '7d735010e9a52fa18b34c7e18e19ee43';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new bidirect_path(null);
