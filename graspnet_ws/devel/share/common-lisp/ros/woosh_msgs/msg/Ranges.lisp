...
(cl:defmethod cl:initialize-instance :after ((m <Ranges>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ranges)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name woosh_msgs-msg:<Ranges> is deprecated: use woosh_msgs-msg:Ranges instead.")))
...
(cl:defmethod ranges-val ((m <Ranges>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader woosh_msgs-msg:ranges-val is deprecated.  Use woosh_msgs-msg:ranges instead.")
  (ranges m))
