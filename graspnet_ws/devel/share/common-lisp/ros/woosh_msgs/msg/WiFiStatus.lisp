...
(cl:defmethod cl:initialize-instance :after ((m <WiFiStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WiFiStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name woosh_msgs-msg:<WiFiStatus> is deprecated: use woosh_msgs-msg:WiFiStatus instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <WiFiStatus>))
