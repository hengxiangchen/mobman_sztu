...
"""autogenerated by genpy from woosh_msgs/TagLocalizationActionResult.msg. Do not edit."""
import codecs
import sys
...
class TagLocalizationActionResult(genpy.Message):
  _md5sum = "78389360c96fd9406a9b225a3042865d"
  _type = "woosh_msgs/TagLocalizationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','woosh_msgs/TagLocalizationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TagLocalizationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = woosh_msgs.msg.TagLocalizationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = woosh_msgs.msg.TagLocalizationResult()
