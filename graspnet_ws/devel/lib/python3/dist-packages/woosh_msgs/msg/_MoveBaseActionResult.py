...
"""autogenerated by genpy from woosh_msgs/MoveBaseActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseActionResult(genpy.Message):
  ...
  _type = "woosh_msgs/MoveBaseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','woosh_msgs/MoveBaseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = woosh_msgs.msg.MoveBaseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = woosh_msgs.msg.MoveBaseResult()
