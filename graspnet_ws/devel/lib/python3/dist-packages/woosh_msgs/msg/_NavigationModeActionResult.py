...
"""autogenerated by genpy from woosh_msgs/NavigationModeActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigationModeActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "woosh_msgs/NavigationModeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','woosh_msgs/NavigationModeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavigationModeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = woosh_msgs.msg.NavigationModeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = woosh_msgs.msg.NavigationModeResult()
