...
"""autogenerated by genpy from woosh_msgs/MoveBaseAction.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseAction(genpy.Message):
  _md5sum = "f6ec9640f836a6ffab06c335943b50c0"
  _type = "woosh_msgs/MoveBaseAction"
...
"""
  ...
  _slot_types = ['woosh_msgs/MoveBaseActionGoal','woosh_msgs/MoveBaseActionResult','woosh_msgs/MoveBaseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = woosh_msgs.msg.MoveBaseActionGoal()
      if self.action_result is None:
        self.action_result = woosh_msgs.msg.MoveBaseActionResult()
      if self.action_feedback is None:
        self.action_feedback = woosh_msgs.msg.MoveBaseActionFeedback()
    else:
      self.action_goal = woosh_msgs.msg.MoveBaseActionGoal()
      self.action_result = woosh_msgs.msg.MoveBaseActionResult()
      self.action_feedback = woosh_msgs.msg.MoveBaseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7dB3I().pack(_x.action_goal.goal.target_pose.pose.position.x, _x.action_goal.goal.target_pose.pose.position.y, _x.action_goal.goal.target_pose.pose.position.z, _x.action_goal.goal.target_pose.pose.orientation.x, _x.action_goal.goal.target_pose.pose.orientation.y, _x.action_goal.goal.target_pose.pose.orientation.z, _x.action_goal.goal.target_pose.pose.orientation.w, _x.action_goal.goal.execution_mode, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7dq().pack(_x.action_feedback.feedback.base_position.pose.position.x, _x.action_feedback.feedback.base_position.pose.position.y, _x.action_feedback.feedback.base_position.pose.position.z, _x.action_feedback.feedback.base_position.pose.orientation.x, _x.action_feedback.feedback.base_position.pose.orientation.y, _x.action_feedback.feedback.base_position.pose.orientation.z, _x.action_feedback.feedback.base_position.pose.orientation.w, _x.action_feedback.feedback.nav_state))
