...
"""autogenerated by genpy from woosh_msgs/Obstacle.msg. Do not edit."""
import codecs
import sys
...
class Obstacle(genpy.Message):
  _md5sum = "da86aba172af141cb4d9b46e19dc661d"
  _type = "woosh_msgs/Obstacle"
...
"""
  __slots__ = ['header','obstacl_pointclouds']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.obstacl_pointclouds is None:
        self.obstacl_pointclouds = []
    else:
      self.header = std_msgs.msg.Header()
      self.obstacl_pointclouds = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.obstacl_pointclouds)
      buff.write(_struct_I.pack(length))
      for val1 in self.obstacl_pointclouds:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.obstacl_pointclouds.append(val1)
      return self
