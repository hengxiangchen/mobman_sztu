...
"""autogenerated by genpy from woosh_msgs/bidirect_path.msg. Do not edit."""
import codecs
import sys
...
class bidirect_path(genpy.Message):
  _md5sum = "7d735010e9a52fa18b34c7e18e19ee43"
  _type = "woosh_msgs/bidirect_path"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(bidirect_path, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.allow_avoid,) = _get_struct_B().unpack(str[start:end])
