...
"""autogenerated by genpy from woosh_msgs/TagLocalizationActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TagLocalizationActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "woosh_msgs/TagLocalizationActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','woosh_msgs/TagLocalizationFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TagLocalizationActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = woosh_msgs.msg.TagLocalizationFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = woosh_msgs.msg.TagLocalizationFeedback()
