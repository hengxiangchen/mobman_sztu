...
"""autogenerated by genpy from woosh_msgs/MultiMapNavigationActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MultiMapNavigationActionGoal(genpy.Message):
  _md5sum = "89b710db4f7859682a90b35c935a6fa7"
  _type = "woosh_msgs/MultiMapNavigationActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','woosh_msgs/MultiMapNavigationGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiMapNavigationActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = woosh_msgs.msg.MultiMapNavigationGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = woosh_msgs.msg.MultiMapNavigationGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.map_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.map_name = str[start:end]
      _x = self
      start = end
      end += 12
