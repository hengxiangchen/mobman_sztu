...
"""autogenerated by genpy from woosh_msgs/mono_path.msg. Do not edit."""
import codecs
import sys
...
class mono_path(genpy.Message):
  _md5sum = "6181e8db9f191cda19a6d8b7ae5e5f25"
  _type = "woosh_msgs/mono_path"
...
float64 w
"""
  __slots__ = ['path','width','allow_avoid']
  _slot_types = ['nav_msgs/Path','float32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mono_path, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.path is None:
        self.path = nav_msgs.msg.Path()
      if self.width is None:
        self.width = 0.
      if self.allow_avoid is None:
        self.allow_avoid = False
    else:
      self.path = nav_msgs.msg.Path()
      self.width = 0.
      self.allow_avoid = False
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.allow_avoid = bool(self.allow_avoid)
      return self
