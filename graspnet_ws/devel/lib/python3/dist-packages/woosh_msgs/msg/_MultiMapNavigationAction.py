...
"""autogenerated by genpy from woosh_msgs/MultiMapNavigationAction.msg. Do not edit."""
import codecs
import sys
...
class MultiMapNavigationAction(genpy.Message):
  _md5sum = "eba9e16a129ad16f4a2cb6782e4df1c6"
  _type = "woosh_msgs/MultiMapNavigationAction"
...
"""
  ...
  _slot_types = ['woosh_msgs/MultiMapNavigationActionGoal','woosh_msgs/MultiMapNavigationActionResult','woosh_msgs/MultiMapNavigationActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MultiMapNavigationAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = woosh_msgs.msg.MultiMapNavigationActionGoal()
      if self.action_result is None:
        self.action_result = woosh_msgs.msg.MultiMapNavigationActionResult()
      if self.action_feedback is None:
        self.action_feedback = woosh_msgs.msg.MultiMapNavigationActionFeedback()
    else:
      self.action_goal = woosh_msgs.msg.MultiMapNavigationActionGoal()
      self.action_result = woosh_msgs.msg.MultiMapNavigationActionResult()
      self.action_feedback = woosh_msgs.msg.MultiMapNavigationActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.map_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.wormhole_feedback
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.map_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.map_name = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.wormhole_feedback,) = _get_struct_i().unpack(str[start:end])
      return self
