...
"""autogenerated by genpy from woosh_msgs/NavPath.msg. Do not edit."""
import codecs
import sys
...
class NavPath(genpy.Message):
  _md5sum = "27705117dadbad8cf0d09e3e8f7c9ac0"
  _type = "woosh_msgs/NavPath"
...
float64 w
"""
  __slots__ = ['path','path_type','path_check_code']
  _slot_types = ['nav_msgs/Path','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       path,path_type,path_check_code
    ...
    if args or kwds:
      ...
      if self.path_type is None:
        self.path_type = 0
      if self.path_check_code is None:
        self.path_check_code = 0
    else:
      self.path = nav_msgs.msg.Path()
      self.path_type = 0
      self.path_check_code = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.path_type, _x.path_check_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.path_type, _x.path_check_code,) = _get_struct_2I().unpack(str[start:end])
      return self
